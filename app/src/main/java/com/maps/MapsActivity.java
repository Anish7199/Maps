...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        latlngs.add(new LatitudeLongitude(27.706050, 85.329990, "Softwarica College"));
        latlngs.add(new LatitudeLongitude(27.704864, 85.329353,"Gopal dai ko chatamari"));
        latlngs.add(new LatitudeLongitude(27.705509, 85.333541,"Lord Buddha Education Foundation"));
